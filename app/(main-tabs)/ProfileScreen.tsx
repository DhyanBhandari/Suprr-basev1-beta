 ...
 * @description User profile management with personal/business mode toggle and dynamic form fields
 * @features - Mode switching, business details management, upgrade prompts, settings configuration
