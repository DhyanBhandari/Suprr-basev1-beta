/**
 * @file favorites.tsx
 * @description Favorites screen displaying user's saved items with search and filter functionality
 * @features - Search favorites, filter by category, remove items, empty state handling
