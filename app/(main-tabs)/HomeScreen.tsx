/**
 * @file HomeScreen.tsx
 * @description Main home screen displaying PLINK logo, user mode toggle, and chat interface
 * @features - User/Business mode switching, animated logo, chat input, hamburger menu
