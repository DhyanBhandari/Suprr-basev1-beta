/**
 * @file InviteScreen.tsx
 * @description Friend invitation and referral system with rewards tracking
 * @features - Invite code sharing, social media integration, referral tracking, reward system
...
export default function InviteScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <Header title="Invite Friends" showBackButton />
