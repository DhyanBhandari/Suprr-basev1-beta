/**
 * @file FeedScreen.tsx
 * @description Content feed displaying posts, trending topics, and recommendations with interaction features
 * @features - Feed refresh, like/bookmark posts, category filtering, social interactions
