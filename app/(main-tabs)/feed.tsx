/**
 * @file feed.tsx
 * @description Social feed screen displaying posts, trending content, and user interactions
 * @features - Post interactions (like, comment, share), refresh functionality, content categorization
