/**
 * @file invite.tsx
 * @description Invite friends screen with referral system, sharing options, and reward tracking
 * @features - Invite code generation, social sharing, email invites, referral statistics
