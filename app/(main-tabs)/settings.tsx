/**
 * @file settings.tsx
 * @description App settings screen with theme selection, notifications, privacy controls, and account management
 * @features - Theme switching, notification toggles, data management, account settings
